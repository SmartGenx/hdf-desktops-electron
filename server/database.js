...
const AuthService = require('../server/services/user/AuthService') // Adjust this path as necessary
const GovernorateService = require('../server/services/systemSetting/governorateService') // Adjust this path as necessary
const DirectorateService = require('../server/services/systemSetting/directorateService') // Adjust this path as necessary
const CategoryService = require('./services/systemSetting/categoryService') // Adjust this path as necessary
const ApplicantService = require('../server/services/applicant/applicantService') // Adjust this path as necessary
const SquareServices = require('../server/services/systemSetting/squareServices') // Adjust this path as necessary
const PharmacyService = require('../server/services/systemSetting/pharmacyService') // Adjust this path as necessary
const DismissalServices = require('../server/services/dismissal/dismissalServices') // Adjust this path as necessary
const AccreditedServices = require('../server/services/accreditation/accreditedServices') // Adjust this path as necessary
const DiseasesApplicantsServices = require('../server/services/applicant/diseasesApplicants/diseasesApplicantsServices') // Adjust this path as necessary
const DiseaseServices = require('../server/services/systemSetting/diseaseServices') // Adjust this path as necessary
const RoleServices = require('../server/services/user/roleServices') // Adjust this path as necessary
const PrescriptionService = require('../server/services/accreditation/prescriptionServices') // Adjust this path as necessary
const AttachmentServiceService = require('../server/services/attachment/attachmentServices') // Adjust this path as necessary
const statisticsServices = require('../server/services/reports/statisticsServices') // Adjust this path as necessary
const backupServices = require('../server/services/backUp/backupServices') // Adjust this path as necessary
