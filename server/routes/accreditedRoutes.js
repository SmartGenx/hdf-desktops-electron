...
accreditedRouter.post('/', upload.fields(fields), copyFileToProfileDir(), AccreditedController.createAccreditation);
...
accreditedRouter.get('/exportAllAccreditedsToPExcl', AccreditedController.exportAllAccreditedByPrescriptionToExcel);
